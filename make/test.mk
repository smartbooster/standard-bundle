...
coverage: ## Launch all tests with code coverage html and text for CI
	XDEBUG_MODE=coverage vendor/bin/simple-phpunit --coverage-text --coverage-html build/phpunit --coverage-cobertura build/phpunit-cobertura.xml --log-junit build/phpunit-report.xml
